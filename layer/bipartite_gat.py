...
class BipartiteGAT(MessagePassing):
    """Bipartite graph attention convolution
    Args:
        in_channels (int): Size of each input sample.
        out_channels (int): Size of each output sample.
        heads (int, optional): Number of multi-head-attentions.
            (default: :obj:`1`)
        attention_concat (bool, optional): If set to :obj:`False`, the attentions are only based on one side.
            (default: :obj:`False`)
        multi_head_concat (bool, optional): If set to :obj:`False`, the multi-head
